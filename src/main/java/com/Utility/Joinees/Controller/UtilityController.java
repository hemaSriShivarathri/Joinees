...
//		Optional<EmployeeLogin> empdetailsList = new ArrayList<>();
		...
		if (empdetailsList != null) {
			System.out.println("empdetailsList" + empdetailsList.toString());
		}
		System.out.println();
...
//			return "Invalid Credentials";
	...
	@PostMapping("/employeeLoginDetails")
	public EmployeeLogin getEmployeeDetails(@RequestBody EmployeeLogin emplogin) {
		EmployeeLogin emp = new EmployeeLogin();
		emp.setEMPID(emplogin.getEMPID());
		emp.setName(emplogin.getName());
		emp.setPassword(emplogin.getPassword());
		emp.setRole(emplogin.getPassword());
		return emp;
	}
}
